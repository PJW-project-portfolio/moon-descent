...
STAGES = (
    StageConfig("MOON", 1.62, 15.0, 45.0),
    StageConfig("MARS", 3.71, 13.0, 50.0),
    StageConfig("VENUS", 8.87, 10.0, 60.0),
    StageConfig("EUROPA", 1.31, 15.0, 45.0),
    StageConfig("TITAN", 1.35, 15.0, 45.0),
)

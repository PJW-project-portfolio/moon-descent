...
class GameSessionTests(unittest.TestCase):
    ...
    def test_third_crash_waits_for_pilot_id_before_recording(self) -> None:
    ...
    def test_name_entry_starts_empty_and_skip_does_not_record(self) -> None:
        ...
        self.assertEqual(session.initials_input, "")
        self.assertEqual(session.phone_input, "")
        self.assertFalse(session.name_entry_error)

    def test_record_run_with_pilot_id_remains_idempotent(self) -> None:
